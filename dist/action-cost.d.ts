...
export declare function getActionCosts(totalCostUsd: number | undefined, tools: ToolEntry[], agents: AgentEntry[], threshold: number, sessionId?: string, overrides?: Partial<ActionCostDeps>): ActionCostEntry[] | null;
