...
function isGovRegion(region?: string): boolean {
...
function isGovModelId(modelId?: string): boolean {
 ...
 */
export function detectBackendProfile(
  stdin: StdinData,
  opts: { env?: NodeJS.ProcessEnv; hasSubscription?: boolean; hasApiKey?: boolean } = {},
): BackendProfile {
 ...
 */
export function backendProfileLabel(profile: BackendProfile): string | null {
